...
type User struct {
	...
	NationalID           null.String `boil:"national_id" json:"national_id,omitempty" toml:"national_id" yaml:"national_id,omitempty"`
	Mobile               string      `boil:"mobile" json:"mobile" toml:"mobile" yaml:"mobile"`
	Email                null.String `boil:"email" json:"email,omitempty" toml:"email" yaml:"email,omitempty"`
	UserLevelID          uint8       `boil:"user_level_id" json:"user_level_id" toml:"user_level_id" yaml:"user_level_id"`
	IsMerchant           uint8       `boil:"is_merchant" json:"is_merchant" toml:"is_merchant" yaml:"is_merchant"`
	IdentityVerification uint8       `boil:"identity_verification" json:"identity_verification" toml:"identity_verification" yaml:"identity_verification"`
	MobileVerification   null.Uint8  `boil:"mobile_verification" json:"mobile_verification,omitempty" toml:"mobile_verification" yaml:"mobile_verification,omitempty"`
	Market               null.Uint8  `boil:"market" json:"market,omitempty" toml:"market" yaml:"market,omitempty"`
	InviterID            null.Uint   `boil:"inviter_id" json:"inviter_id,omitempty" toml:"inviter_id" yaml:"inviter_id,omitempty"`
...
var UserTableColumns = struct {
	...
	Mobile:               "users.mobile",
	Email:                "users.email",
	UserLevelID:          "users.user_level_id",
	IsMerchant:           "users.is_merchant",
	IdentityVerification: "users.identity_verification",
	MobileVerification:   "users.mobile_verification",
	Market:               "users.market",
	InviterID:            "users.inviter_id",
	EditedAt:             "users.edited_at",
...
var UserWhere = struct {
	...
	NationalID           whereHelpernull_String
	Mobile               whereHelperstring
	Email                whereHelpernull_String
	UserLevelID          whereHelperuint8
	IsMerchant           whereHelperuint8
	IdentityVerification whereHelperuint8
	MobileVerification   whereHelpernull_Uint8
	Market               whereHelpernull_Uint8
	InviterID            whereHelpernull_Uint
	EditedAt             whereHelpernull_Time
	CreatedAt            whereHelpertime_Time
}{
	UserID:               whereHelperuint{field: "`users`.`user_id`"},
	Name:                 whereHelperstring{field: "`users`.`name`"},
	Family:               whereHelperstring{field: "`users`.`family`"},
	NationalID:           whereHelpernull_String{field: "`users`.`national_id`"},
	Mobile:               whereHelperstring{field: "`users`.`mobile`"},
	Email:                whereHelpernull_String{field: "`users`.`email`"},
	UserLevelID:          whereHelperuint8{field: "`users`.`user_level_id`"},
	IsMerchant:           whereHelperuint8{field: "`users`.`is_merchant`"},
	IdentityVerification: whereHelperuint8{field: "`users`.`identity_verification`"},
	MobileVerification:   whereHelpernull_Uint8{field: "`users`.`mobile_verification`"},
	Market:               whereHelpernull_Uint8{field: "`users`.`market`"},
	InviterID:            whereHelpernull_Uint{field: "`users`.`inviter_id`"},
	EditedAt:             whereHelpernull_Time{field: "`users`.`edited_at`"},
...
var UserRels = struct {
	...
	Inviter:      "Inviter",
	Payments:     "Payments",
	InviterUsers: "InviterUsers",
	Wallets:      "Wallets",
}

// userR is where relationships are stored.
type userR struct {
	Inviter      *User        `boil:"Inviter" json:"Inviter" toml:"Inviter" yaml:"Inviter"`
	Payments     PaymentSlice `boil:"Payments" json:"Payments" toml:"Payments" yaml:"Payments"`
	InviterUsers UserSlice    `boil:"InviterUsers" json:"InviterUsers" toml:"InviterUsers" yaml:"InviterUsers"`
...
var (
	userAllColumns            = []string{"user_id", "name", "family", "national_id", "mobile", "email", "user_level_id", "is_merchant", "identity_verification", "mobile_verification", "market", "inviter_id", "edited_at", "created_at"}
	userColumnsWithoutDefault = []string{"name", "family", "national_id", "mobile", "email", "user_level_id", "market", "inviter_id", "edited_at"}
	userColumnsWithDefault    = []string{"user_id", "is_merchant", "identity_verification", "mobile_verification", "created_at"}
...
func (o *User) Inviter(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
		qm.Where("`user_id` = ?", o.InviterID),
	}
...
func (o *User) Payments(mods ...qm.QueryMod) paymentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`payments`.`user_id`=?", o.UserID),
	)
...
// InviterUsers retrieves all the user's Users with an executor via inviter_id column.
func (o *User) InviterUsers(mods ...qm.QueryMod) userQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`users`.`inviter_id`=?", o.UserID),
	)
...
func (o *User) Wallets(mods ...qm.QueryMod) walletQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`wallets`.`user_id`=?", o.UserID),
	)
...
func (userL) LoadInviter(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	if singular {
		...
		if !queries.IsNil(object.InviterID) {
	...
	Outer:
		for _, obj := range slice {
			...
			for _, a := range args {
				if queries.Equal(a, obj.InviterID) {
					continue Outer
				}
			}

			if !queries.IsNil(obj.InviterID) {
	...
	if singular {
		...
		foreign.R.InviterUsers = append(foreign.R.InviterUsers, object)
		return nil
	}

	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.InviterID, foreign.UserID) {
				local.R.Inviter = foreign
				if foreign.R == nil {
					foreign.R = &userR{}
				}
				foreign.R.InviterUsers = append(foreign.R.InviterUsers, local)
				break
			}
		}
	}
...
// LoadInviterUsers allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadInviterUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`users`),
		qm.WhereIn(`users.inviter_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.InviterUsers = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &userR{}
			}
			foreign.R.Inviter = object
		}
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.UserID, foreign.InviterID) {
				local.R.InviterUsers = append(local.R.InviterUsers, foreign)
				if foreign.R == nil {
					foreign.R = &userR{}
				}
				foreign.R.Inviter = local
				break
			}
		}
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadWallets(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`wallets`),
		qm.WhereIn(`wallets.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetInviter of the user to the related item.
// Sets o.R.Inviter to related.
// Adds o to related.R.InviterUsers.
func (o *User) SetInviter(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
	...
	updateQuery := fmt.Sprintf(
		...
		strmangle.SetParamNames("`", "`", 0, []string{"inviter_id"}),
	...
	queries.Assign(&o.InviterID, related.UserID)
	if o.R == nil {
		o.R = &userR{
			Inviter: related,
		}
	...
	if related.R == nil {
		related.R = &userR{
			InviterUsers: UserSlice{o},
		}
	} else {
		related.R.InviterUsers = append(related.R.InviterUsers, o)
	}

	return nil
}

// RemoveInviter relationship.
// Sets o.R.Inviter to nil.
// Removes o from all passed in related items' relationships struct (Optional).
func (o *User) RemoveInviter(ctx context.Context, exec boil.ContextExecutor, related *User) error {
	var err error

	queries.SetScanner(&o.InviterID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("inviter_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}
	...
	for i, ri := range related.R.InviterUsers {
		if queries.Equal(o.InviterID, ri.InviterID) {
			continue
		}

		ln := len(related.R.InviterUsers)
		if ln > 1 && i < ln-1 {
			related.R.InviterUsers[i] = related.R.InviterUsers[ln-1]
		}
		related.R.InviterUsers = related.R.InviterUsers[:ln-1]
		break
	}
	return nil
}
...
// Sets o.R.User's Payments accordingly.
// Replaces o.R.Payments with related.
// Sets related.R.User's Payments accordingly.
func (o *User) SetPayments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Payment) error {
	query := "update `payments` set `user_id` = null where `user_id` = ?"
...
// Sets related.R.User.
func (o *User) RemovePayments(ctx context.Context, exec boil.ContextExecutor, related ...*Payment) error {
	if len(related) == 0 {
		return nil
	}
...
// AddInviterUsers adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.InviterUsers.
// Sets related.R.Inviter appropriately.
func (o *User) AddInviterUsers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*User) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.InviterID, o.UserID)
			if err = rel.Insert(ctx, exec, boil.Infer()); err != nil {
				return errors.Wrap(err, "failed to insert into foreign table")
			}
		} else {
			...
			values := []interface{}{o.UserID, rel.UserID}
	...
	if o.R == nil {
		o.R = &userR{
			InviterUsers: related,
		}
	} else {
		o.R.InviterUsers = append(o.R.InviterUsers, related...)
	}
...
// SetInviterUsers removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Inviter's InviterUsers accordingly.
// Replaces o.R.InviterUsers with related.
// Sets related.R.Inviter's InviterUsers accordingly.
func (o *User) SetInviterUsers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*User) error {
	query := "update `users` set `inviter_id` = null where `inviter_id` = ?"
	values := []interface{}{o.UserID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
	...
	if o.R != nil {
		for _, rel := range o.R.InviterUsers {
			queries.SetScanner(&rel.InviterID, nil)
			if rel.R == nil {
				continue
			}
		...
		o.R.InviterUsers = nil
	}
	return o.AddInviterUsers(ctx, exec, insert, related...)
}

// RemoveInviterUsers relationships from objects passed in.
// Removes related items from R.InviterUsers (uses pointer comparison, removal does not keep order)
// Sets related.R.Inviter.
func (o *User) RemoveInviterUsers(ctx context.Context, exec boil.ContextExecutor, related ...*User) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		...
		if _, err = rel.Update(ctx, exec, boil.Whitelist("inviter_id")); err != nil {
			return err
		}
	}
	if o.R == nil {
	...
	for _, rel := range related {
		for i, ri := range o.R.InviterUsers {
			if rel != ri {
				continue
			}

			ln := len(o.R.InviterUsers)
			if ln > 1 && i < ln-1 {
				o.R.InviterUsers[i] = o.R.InviterUsers[ln-1]
			}
			o.R.InviterUsers = o.R.InviterUsers[:ln-1]
			break
		}
	}
...
// Sets related.R.User appropriately.
func (o *User) AddWallets(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Wallet) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.UserID
			...
			values := []interface{}{o.UserID, rel.WalletID}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update users row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by update for users")
	}
...
func (q userQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to update all for users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to retrieve rows affected for users")
	}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("entities: unable to upsert users, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to upsert for users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to retrieve unique values for users")
	}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by delete for users")
	}
...
func (q userQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entities: unable to delete all from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entities: failed to get rows affected by deleteall for users")
	}
